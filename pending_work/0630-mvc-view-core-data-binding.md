# [0630] Mvc\View — core & data binding

**Phase:** Phase 4 — Core MVC
**Target source:** `src/Mvc/View.php`
**Test file to create:** `tests/Unit/Mvc/ViewTest.php`

## Scope
Cover set/get of view data, escape(), getName(), engine selection (.blade.php vs .php), and loadTemplate/display against simple .php template fixtures.

## Notes & gotchas
Create tiny template fixtures under tests/Unit/Mvc/_data/views. Inject a minimal Container. ViewTemplateFinder is covered separately ([[0635]]).
...
- [ ] One commit containing the new test (and the deletion), message style: `test: add Mvc\View — core & data binding`.

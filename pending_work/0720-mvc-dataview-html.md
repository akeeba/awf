# [0720] Mvc\DataView\Html

**Phase:** Phase 4 — Core MVC
**Target source:** `src/Mvc/DataView/Html.php`
**Test file to create:** `tests/Unit/Mvc/DataView/HtmlViewTest.php`

## Scope
Cover the HTML DataView task→layout mapping (browse/read/add/edit), pagination wiring, and default layout selection.

## Notes & gotchas
Use template fixtures; inject minimal Container. Relates to [[0630]].
...
- [ ] One commit containing the new test (and the deletion), message style: `test: add Mvc\DataView\Html`.

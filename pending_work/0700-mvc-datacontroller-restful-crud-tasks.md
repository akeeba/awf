# [0700] Mvc\DataController — RESTful CRUD tasks

**Phase:** Phase 4 — Core MVC
**Target source:** `src/Mvc/DataController.php`
**Test file to create:** `tests/Unit/Mvc/DataControllerTest.php`

## Scope
Cover the browse/read/add/edit/save/delete tasks, how they drive the DataModel, and the redirect/state outcomes.

## Notes & gotchas
Use a fixture DataModel + DataController over SQLite. Stub redirects (override in subclass). Builds on [[0620]] [[0650]].
...
- [ ] One commit containing the new test (and the deletion), message style: `test: add Mvc\DataController — RESTful CRUD tasks`.

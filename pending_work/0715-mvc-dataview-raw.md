# [0715] Mvc\DataView\Raw

**Phase:** Phase 4 — Core MVC
**Target source:** `src/Mvc/DataView/Raw.php`
**Test file to create:** `tests/Unit/Mvc/DataView/RawViewTest.php`

## Scope
Cover raw passthrough output behaviour.
...
- [ ] One commit containing the new test (and the deletion), message style: `test: add Mvc\DataView\Raw`.

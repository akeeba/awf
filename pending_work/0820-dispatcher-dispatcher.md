# [0820] Dispatcher\Dispatcher

**Phase:** Phase 5 — Everything else
**Target source:** `src/Dispatcher/Dispatcher.php`
**Test file to create:** `tests/Unit/Dispatcher/DispatcherTest.php`

## Scope
Cover dispatch() creating a controller via mvcFactory, the onBeforeDispatch/onAfterDispatch events, and default controller/task resolution.

## Notes & gotchas
Use fixture controller + minimal Container with a stub mvcFactory.
...
- [ ] One commit containing the new test (and the deletion), message style: `test: add Dispatcher\Dispatcher`.

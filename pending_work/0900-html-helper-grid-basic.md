# [0900] Html\Helper\Grid + Basic

**Phase:** Phase 5 — Everything else
**Target source:** `src/Html/Helper/Grid.php, src/Html/Helper/Basic.php`
**Test file to create:** `tests/Unit/Html/Helper/GridTest.php`

## Scope
Cover sort headers, check-all/id checkboxes, ordering controls, and the basic helper utilities. Assert generated HTML.

## Notes & gotchas
Inject minimal Container/Input for state-dependent output.
...
- [ ] One commit containing the new test (and the deletion), message style: `test: add Html\Helper\Grid + Basic`.

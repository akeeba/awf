...
class QueryTest extends \PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->instance = new Query($this->dbo);
	}
	...
	/**
	 * Test for the \Awf\Database\Query::__call method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::__call
	 * @since   1.0
	 */
	...
	/**
	 * Test for the \Awf\Database\Query::__get method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::__get
	 * @since   1.0
	 */
	...
	/**
	 * Test for the \Awf\Database\Query::__string method for a 'select' case.
	 *
	 * @return  void
	 *
	 * @since   1.0
	...
	/**
	 * Test for the \Awf\Database\Query::__string method for a 'update' case.
	 *
	 * @return  void
	 *
	 * @since   1.0
	 ...
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::__toString
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::call method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::call
	 * @since   1.0
	 */
	 ...
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::castAsChar
	 * @since   1.0
	 */
	 ...
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::charLength
	 * @since   1.0
	 */
	 ...
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::clear
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::columns method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::columns
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::concatenate method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::concatenate
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::currentTimestamp method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::currentTimestamp
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::dateFormat method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::dateFormat
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::dateFormat method for an expected exception.
	 *
	 * @return  void
	 *
	 * @covers             \Awf\Database\Query::dateFormat
	...
	/**
	 * Tests the \Awf\Database\Query::delete method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::delete
	 * @since   1.0
	 */
	...
	/**
	 * Tests the delete property in \Awf\Database\Query::__toString method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::__toString
	...
	/**
	 * Tests the \Awf\Database\Query::dump method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::dump
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::escape method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::escape
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::escape method for an expected exception.
	 *
	 * @return  void
	 *
	 * @covers             \Awf\Database\Query::escape
	...
	/**
	 * Tests the \Awf\Database\Query::exec method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::exec
	 * @since   1.0
	 */
	...
	/**
	 * Tests the exec property in \Awf\Database\Query::__toString method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::__toString
	...
	/**
	 * Tests the \Awf\Database\Query::from method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::from
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::group method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::group
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::having method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::having
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::innerJoin method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::innerJoin
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::insert method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::insert
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::join method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::join
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::leftJoin method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::leftJoin
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::length method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::length
	 * @since   1.0
	 */
	 ...
	 * @return  void
	 *
	 * @covers        \Awf\Database\Query::nullDate
	...
	/**
	 * Tests the \Awf\Database\Query::nullDate method for an expected exception.
	 *
	 * @return  void
	 *
	 * @covers             \Awf\Database\Query::nullDate
	...
	/**
	 * Tests the \Awf\Database\Query::order method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::order
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::outerJoin method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::outerJoin
	 * @since   1.0
	 */
	 ...
	 * @return  void
	 *
	 * @covers        \Awf\Database\Query::quote
	 * @since      1.0
	 ...
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::quoteName
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::quoteName method for an expected exception.
	 *
	 * @return  void
	 *
	 * @covers             \Awf\Database\Query::quoteName
	...
	/**
	 * Tests the \Awf\Database\Query::rightJoin method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::rightJoin
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::select method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::select
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::set method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::set
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::setQuery method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::setQuery
	 * @since   1.0
	 */
	...
	/**
	 * Tests rendering coupled with the \Awf\Database\Query::setQuery method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::__toString
	...
	/**
	 * Tests the \Awf\Database\Query::update method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::update
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::values method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::values
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::where method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::where
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::__clone method properly clones an array.
	 *
	 * @return  void
	 *
	 * @since   1.0
	...
	/**
	 * Tests the \Awf\Database\Query::__clone method properly clones an object.
	 *
	 * @return  void
	 *
	 * @since   1.0
	...
	/**
	 * Tests the \Awf\Database\Query::union method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::union
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::unionDistinct method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::unionDistinct
	 * @since   1.0
	 */
	...
	/**
	 * Tests the \Awf\Database\Query::format method.
	 *
	 * @return  void
	 *
	 * @covers  \Awf\Database\Query::format
	 * @since   1.0
	 */

...
class MysqlTest extends AwfTestCase
{
	...
	{
		$q = new \Awf\Database\Query\Mysql($this->dbo);
	...
	/**
	 * Test for the \Awf\Database\Query\Mysql::__string method for a 'update' case.
	 *
	 * @return  void
	 *
	 * @since   1.1
	...
	{
		$q = new \Awf\Database\Query\Mysql($this->dbo);
		$subq = new \Awf\Database\Query\Mysql($this->dbo);
	...
	public function testChaining()
	{
		...
		$this->assertThat(
			$q,
			$this->isInstanceOf('\Awf\Database\Query')
		);
	}
	...
	{
		$q = new \Awf\Database\Query\Mysql($this->dbo);
		$q2 = new \Awf\Database\Query\Mysql($this->dbo);
	...
	/**
	 * Tests the \Awf\Database\Query\Mysql::escape method.
	 *
	 * @return  void
	 *
	 * @since   1.1
	...
	/**
	 * Tests the \Awf\Database\Query\Mysql::processLimit method.
	 *
	 * @return  void
	 *
	 * @since   1.1

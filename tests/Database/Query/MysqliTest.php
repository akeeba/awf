...
class MysqliTest extends AwfTestCase
{
	...
	{
		$q = new \Awf\Database\Query\Mysqli($this->dbo);
	...
	/**
	 * Test for the \Awf\Database\Query\Mysqli::__string method for a 'update' case.
	 *
	 * @return  void
	 *
	 * @since   1.1
	...
	{
		$q = new \Awf\Database\Query\Mysqli($this->dbo);
		$subq = new \Awf\Database\Query\Mysqli($this->dbo);
	...
	{
		$q = new \Awf\Database\Query\Mysqli($this->dbo);
		$q2 = new \Awf\Database\Query\Mysqli($this->dbo);
	...
	/**
	 * Tests the \Awf\Database\Query\Mysqli::escape method.
	 *
	 * @return  void
	 *
	 * @since   1.1

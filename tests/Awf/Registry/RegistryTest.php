...
namespace Tests\Awf\Registry;
use Awf\Registry\Registry;
use Tests\Helpers\ReflectionHelper;

/**
 * @coversDefaultClass Awf\Registry\Registry
 *
 * @package Tests\Awf\Registry
 */
class RegistryTest extends \PHPUnit_Framework_TestCase
{
	/**
	 * Test the Awf\Registry\Registry::__clone method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::__clone
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::__toString method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::__toString
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::jsonSerialize method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::jsonSerialize
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::def method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::def
	 * @since   1.0
	 */
	...
	/**
	 * Tet the Awf\Registry\Registry::bindData method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::bindData
	 * @since   1.0
	 */
	public function testBindData()
	{
		...
		ReflectionHelper::invoke($a, 'bindData', $parent, 'foo');
		$this->assertThat(
			$parent->{0},
			$this->equalTo('foo'),
		...
		ReflectionHelper::invoke($a, 'bindData', $parent, array('foo' => 'bar', 'nullstring' => null));
		$this->assertThat(
			$parent->{'foo'},
			$this->equalTo('bar'),
			'Line: ' . __LINE__ . ' The input value should exist in the parent object.'
		...
		ReflectionHelper::invoke($a, 'bindData', $parent, array('level1' => array('level2' => 'value2')));
		$this->assertThat(
		...
		ReflectionHelper::invoke($a, 'bindData', $parent, array('intarray' => array(0, 1, 2)));
		$this->assertThat(
			$parent->{'intarray'},
	...
	/**
	 * Test the Awf\Registry\Registry::exists method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::exists
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::get method
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::get
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::getInstance method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::getInstance
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::loadArray method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::loadArray
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::loadFile method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::loadFile
	 * @since   1.0
	 */
	public function testLoadFile()
	{
		...
		// JSON.
		$result = $registry->loadFile(__DIR__ . '/../../data/registry/data.json');
		...
		// INI.
		$result = $registry->loadFile(__DIR__ . '/../../data/registry/data.ini', 'ini');
		...
		// INI + section.
		$result = $registry->loadFile(__DIR__ . '/../../data/registry/data.ini', 'ini', array('processSections' => true));
	...
	/**
	 * Test the Awf\Registry\Registry::loadString() method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::loadString
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::loadObject method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::loadObject
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::merge method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::merge
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::offsetExists method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::offsetExists
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::offsetGet method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::offsetGet
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::offsetSet method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::offsetSet
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::offsetUnset method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::offsetUnset
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::set method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::set
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::toArray method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::toArray
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::toObject method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::toObject
	 * @since   1.0
	 */
	...
	/**
	 * Test the Awf\Registry\Registry::toString method.
	 *
	 * @return  void
	 *
	 * @covers  Awf\Registry\Registry::toString
	 * @since   1.0
	 */

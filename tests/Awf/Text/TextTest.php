...
class TextTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testAddIniProcessCallback()
	{
		...
		Text::addIniProcessCallback(array('\\Tests\\Stubs\\Text\\TextCallbacks', 'donada'));

		$this->assertEquals(
			array(array('\\Tests\\Stubs\\Text\\TextCallbacks', 'donada')),
	...
	public function testLoadLanguage()
	{
		...
		ReflectionHelper::setValue('\Awf\Text\Text', 'iniProcessCallbacks', array());
		ReflectionHelper::setValue('\Awf\Text\Text', 'strings', array());
		Text::addIniProcessCallback(array('\\Tests\\Stubs\\Text\\TextCallbacks', 'block'));
		Text::loadLanguage('en-GB', 'lang', '.ini', true, __DIR__ . '/../../data');
		$strings = ReflectionHelper::getValue('\Awf\Text\Text', 'strings');
		...
		ReflectionHelper::setValue('\Awf\Text\Text', 'iniProcessCallbacks', array());
		ReflectionHelper::setValue('\Awf\Text\Text', 'strings', array());
		Text::addIniProcessCallback(array('\\Tests\\Stubs\\Text\\TextCallbacks', 'preprocess'));
		Text::loadLanguage('en-GB', 'lang', '.ini', true, __DIR__ . '/../../data');
		$strings = ReflectionHelper::getValue('\Awf\Text\Text', 'strings');
